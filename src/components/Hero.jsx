...
export function Hero() {
    ...
    return (
        <>
            <main class="text-neutral-50 flex flex-col gap-10 items-center" id="inicio">
                ...
                <footer class="flex items-center justify-center gap-5">
                    ...
                    <a
                        href={whatsApp}
                        target="_blank"
                        class="underline font-semibold text-lg text-neutral-50 rounded-lg bg-yellow-guataca transition px-6 py-4 border border-yellow-guataca uppercase"
                    >
                        ¡Pide Aquí!
                    </a>
                </footer>
